package com.tekskills.st_tekskills.utils.location.workers
...
import com.tekskills.st_tekskills.utils.location.receiver.LocationUpdateReceiver
...
//            notificationManager.notify(Random.nextInt(), notification)
    ...
    companion object {
        const val UPDATE_INTERVAL = (1000 * 60 * 60).toLong() // 60 minutes
        const val MIN_DISTANCE = 1000f // 1000 meters
    }
}
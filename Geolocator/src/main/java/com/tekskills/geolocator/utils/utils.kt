...
package com.tekskills.geolocator.utils
...
import com.tekskills.geolocator.geofencer.service.GeoFenceUpdateWorker
import com.tekskills.geolocator.geofencer.service.GeofenceBootWorker
import com.tekskills.geolocator.tracking.service.LocationTrackerUpdateWorker
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return activity?.let {
            ...
            builder.setMessage(rationalMessage)
                .setPositiveButton(
                    com.tekskills.geolocator.R.string.button_allow
                ) { _, _ ->
                    block(true)
                }
                .setNegativeButton(
                    com.tekskills.geolocator.R.string.button_reject
                ) { _, _ ->
                    block(false)
                }
